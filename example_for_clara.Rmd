...
#### ------ EXAMPLE OF  DataGeneration ####
simulation_data <- DataGeneration(n_lab, n_unlab, p, rho, signal = c(1, 1, 0.5, 0.5),
...
#### ------ EXAMPLE OF  SemiSupervisedMinVarRegression#### 
...
#### ------ EXAMPLE OF DensityRatioRegression ####
dr_method <- DensityRatioRegression(basis_labeled, basis_unlabeled, X_labeled,
...
#### ------ EXAMPLE OF RegressionStdErrorEstimation ####

beta_sl_se_obj <- RegressionStdErrorEstimation(X_labeled, X_unlabeled, y,
                                     beta_sl, resids_sl)
beta_ssl_se_obj <- RegressionStdErrorEstimation(X_labeled, X_unlabeled, y,
...
#### ------ EXAMPLE OF SupervisedApparentAccuracy ####
acc_sl <- SupervisedApparentAccuracy(X_labeled, y, beta_sl, samp_prob,
                                     resamp_weight = NULL,
                                     threshold = my_threshold)

#### ------ EXAMPLE OF SemiSupervisedApparentAccuracy ####
